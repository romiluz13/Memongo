...
vi.mock("../../packages/memory-engine/src/mongodb-schema.js", () => ({
	eventsCollection: vi.fn(),
}))

import { recallConversation } from "../../packages/memory-engine/src/mongodb-conversation-recall.js"
import { eventsCollection } from "../../packages/memory-engine/src/mongodb-schema.js"

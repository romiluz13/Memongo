...
| --- | --- | --- | --- |
| MemPalace | `6957c7e599` | Fast-forwarded | P0 comparison source; committed result artifacts remain present. |
| Mem0 | `3e6ab39429` | Fast-forwarded | README points to `mem0ai/memory-benchmarks` for reproducible numbers. |
| Memory Benchmarks | `4b61c5d31b` | Newly cloned | Official Mem0 benchmark harness and committed results. |
| Supermemory | `9fa626cf17` | Fast-forwarded | README claims #1 rows; MemoryBench is the reproducible harness. |
| MemoryBench | `118209a746` | Newly cloned | Official provider-neutral benchmark framework. |
| Zep | `faf2acec4f` | Already current | LoCoMo CLI harness and LongMemEval notebooks. |
| Mastra | `2d380cfffd` | Fast-forwarded | LongMemEval answer-quality benchmark package. |
| Hindsight | `eadb510eb3` | Fast-forwarded | LoCoMo and LongMemEval benchmark scripts. |
| OpenViking | `c72c8a87e8` | Fast-forwarded | LoCoMo/openclaw-eval and RAG benchmark surfaces. |
| OpenClaw Eval | `75e07d696e` | Newly cloned | External LoCoMo evaluation script referenced by OpenViking. |
...
- Manifest: `artifacts/competitor-snapshots/20260527-a/manifest.json`
- Refresh report: `artifacts/competitor-snapshots/20260527-a/refresh-report.json`
- Bundles: `artifacts/competitor-snapshots/20260527-a/bundles/*.bundle`
...
| P1 | Mem0 | LongMemEval platform top-50 | 94.8% in README; committed platform result top-50 reports 90.4% answer accuracy | Judged answer accuracy | LongMemEval-S, 500 | Answer context | Top-50 search | GPT-5 answerer/judge in committed result metadata | `memory-benchmarks/results/platform/longmemeval_top50_results.json` | TODO: Build Memongo Memory Benchmarks adapter; do not compare to retrieval recall |
| P1 | Mem0 | LongMemEval platform top-200 | 94.4% in README; committed platform result top-200 reports 93.4% pass rate | Judged answer accuracy | LongMemEval-S, 500 | Answer context | Top-200 search | GPT-5 answerer/judge | `memory-benchmarks/results/platform/longmemeval_results.json` | TODO |
| P1 | Mem0 | LoCoMo platform top-50 | 91.8% | Judged answer accuracy | LoCoMo, 1,540 rows | Answer context | Top-50 search | GPT-5 answerer/judge | `memory-benchmarks/results/platform/locomo_top50_results.json` | TODO: run same 1,540-row judged lane |
| P1 | Mem0 | LoCoMo platform top-200 | 92.5% | Judged answer accuracy | LoCoMo, 1,540 rows | Answer context | Top-200 search | GPT-5 answerer/judge | `memory-benchmarks/results/platform/locomo_results.json` | TODO |
| P1 | Mem0 | BEAM 1M top-200 | 70.1% pass rate, 0.641 avg score | Judged answer quality | BEAM 1M, 700 questions | Answer context | Top-200 search | GPT-5 answerer/judge | `memory-benchmarks/results/platform/beam_1m_results.json` | TODO: build BEAM adapter |
| P1 | Mem0 | BEAM 10M top-200 | 50.5% pass rate, 0.486 avg score | Judged answer quality | BEAM 10M, 200 questions | Answer context | Top-200 search | GPT-5 answerer/judge | `memory-benchmarks/results/platform/beam_10m_results.json` | TODO |
...
2. Mem0 Memory Benchmarks: implement a Memongo provider for `memory-benchmarks`; run LongMemEval top-50/top-200, LoCoMo top-50/top-200, BEAM 1M, and BEAM 10M with the same answerer/judge settings.
